  // This example requires the Places library. Include the libraries=places
    ...
    //       var lat = marker.getPosition().lat();
    //       var lon = marker.getPosition().lng();
    //         // var latm = angular.element(document.getElementById("modificarlat")).scope();
    //         // var lngm = angular.element(document.getElementById("modificarlng")).scope();
    //         $scope.modificarlat = latm;
    //         $scope.modificarlng = lngm;
    //         console.log($scope.modificarlat);
    //         console.log($scope.modificarlng);
    //         // modificarlat.lat = lat;
    //         // modificarlng.lng = lon;
